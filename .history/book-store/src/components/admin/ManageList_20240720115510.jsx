...
const ManageList = (props) => {
    const category = [
        ...
        },
        {
            ...
            fields: [
                ...
                { name: "Stock", style: "w-[80px] text-center" },
                { name: "Price", style: "w-[80px] text-center" },
    ...
    return (
        <div
            className="max-w-[1200px] w-[1200px] p-[20px] pr-[50px]
        ...
        >
            ...
            {/*//* List Item */}
            <div className="flex flex-col max-h-[463px] overflow-auto">
