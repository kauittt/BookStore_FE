...
const ManageItem = ({ data, category, ...props }) => {
    ...
    const isImage = data.image ? true : false;
    ...
    return (
        ...
        >
            ...
            {isImage ? (
                ...
                <p className={`${category[1].style} `}>Tăng Khải Minh</p>
            )}

            <p className={`${category[2].style} `}>
                {data.name + " - " + data.author}
            </p>

            <p className={`${category[3].style} `}>Danh mục</p>

            <p className={`${category[4].style} `}>{data.quantity}</p>

            <p className={`${category[5].style} `}>{data.price}$</p>

            <p className={`${category[6].style} `}>{data.description}</p>
