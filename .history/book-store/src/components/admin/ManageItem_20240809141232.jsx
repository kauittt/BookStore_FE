...
const ManageItem = ({ data, category, ...props }) => {
    ...
    return (
        ...
        >
            ...
            <p className={`${props.category[4].style} `}>{data.quantity}</p>

            <p className={`${props.category[5].style} `}>{data.price}$</p>

            <p className={`${props.category[6].style} `}>{data.description}</p>
