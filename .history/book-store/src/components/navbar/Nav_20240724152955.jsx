                ...
                <div className="flex md:order-1">
                    <div className="relative  md:block">
                        ...
                        <input
                            ...
                            focus:ring-blue-500 focus:border-text-color dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            placeholder="Search..."
                        />
                    </div>
                </div>
