...
const Checkout = () => {
    ...
    return (
        <div className="flex w-full h-screen">
            {/*//! Form */}
            <div className="w-1/2 flex flex-col items-center justify-between p-[20px]">
                {/*//* Greeting */}
            ...
            {/*//! Information */}
            <div
                className="w-1/2  flex flex-col items-center justify-between p-[20px]
            ...
            >
                ...
                "
                >
                    <p className="font-semibold text-2xl">Books</p>
