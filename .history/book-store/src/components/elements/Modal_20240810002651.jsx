...
const Modal = ({ onClose, data, onSave, category, mapping, content }) => {
    ...
    if (content === "book") {
        ...
        Object.keys(data).forEach((field) => {
            if (field != "field0") initialValues[field] = data[field] || "";
        });
    }
                                ...
                                {Object.keys(initialValues).map(
                                    (field, index) => (
                                        <FormInput
                                            ...
                                            id={field}
                                            name={field}
                                            placeholder={`Enter ${mapping[field]}`}
                                            type={
