    ...
    return (
        <div
            className="group m-w-[300px] w-[300px] h-[400px] m-h-[400px] bg-bgr-main  rounded p-[20px]
                        ...
                        flex flex-col justify-between items-center cursor-pointer gap-[20px]
                        relative"
        >
            {/*//* Image wrapper  */}
            <div
                className="flex items-center justify-center 
                         max-w-[200px] w-[200px] min-h-[280px] max-h-[280px] rounded 
            ...
            >
                ...
                <div className="max-w-[200px] w-[200px] max-h-full h-full overflow-hidden">
                    <img
                        className="max-w-[200px] w-[200px] max-h-full h-full object-cover rounded 
                    shadow-[rgba(50,_50,_105,_0.15)_0px_2px_5px_0px,_rgba(0,_0,_0,_0.05)_0px_1px_1px_0px]
