    ...
    return (
        ...
        >
            <div className="flex items-center justify-center w-[100%] min-h-[280px] max-h-[280px] rounded  ">
                <img
                    className="w-[200px] h-full object-cover rounded shadow-[rgba(50,_50,_105,_0.15)_0px_2px_5px_0px,_rgba(0,_0,_0,_0.05)_0px_1px_1px_0px] "
                    src={props.image}
                    alt="Image"
                />
            </div>
            <div className="flex justify-between items-center mt-[20px] gap-[10px]">
                <div className="flex flex-col gap-[5px]">
                    <p className="text-lg font-semibold truncate truncate overflow-hidden text-overflow-ellipsis white-space-nowrap">
                        {props.name}
                    </p>
                    <p className="text-base  text-text-light truncate truncate overflow-hidden text-overflow-ellipsis white-space-nowrap">
                        {props.author}
                    </p>
                </div>
