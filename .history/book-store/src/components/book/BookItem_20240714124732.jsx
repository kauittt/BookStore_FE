...
const BookItem = (props) => {
    ...
    return (
        <div
            className="w-[100%] h-[300px] m-h-[300px] overflow-hidden bg-bgr-main bg-[#00aefd] rounded
                        p-[20px] shadow-[rgba(50,_50,_105,_0.15)_0px_2px_5px_0px,_rgba(0,_0,_0,_0.05)_0px_1px_1px_0px]
                        flex flex-col justify-between"
        >
            <div className="flex items-center justify-center w-full min-h-[200px] max-h-[200px] rounded  ">
                <img
                    className="w-[70%] h-full object-cover rounded shadow-[rgba(50,_50,_105,_0.15)_0px_2px_5px_0px,_rgba(0,_0,_0,_0.05)_0px_1px_1px_0px] "
                    src={props.image}
                    alt="Image"
                />
            </div>
