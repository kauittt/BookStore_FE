...
const BookItem = (props) => {
    ...
    return (
        <div
            className="w-[100%] h-[300px] overflow-hidden bg-bgr-main bg-[#00aefd] rounded
                        p-[20px] mt-[120px] shadow-[rgba(50,_50,_105,_0.15)_0px_2px_5px_0px,_rgba(0,_0,_0,_0.05)_0px_1px_1px_0px]
