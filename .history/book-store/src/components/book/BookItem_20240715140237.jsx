        ...
        >
            ...
            >
                ...
                <div className="max-w-[200px] w-[200px] max-h-full h-full overflow-hidden absolute">
                    ...
                    >
                        <span className="text-text-white text-3xl mx-2 p-[5px] bg-bgr-color hover:text-text-color">
                            <FontAwesomeIcon icon={faMagnifyingGlass} />
                        </span>
                        <span className="text-text-white text-3xl mx-2 hover:text-text-color">
