    ...
    return (
        ...
        >
            ...
            >
                ...
                />
                <div
                    className="absolute inset-0 bg-bgr-color-hover bg-opacity-25 opacity-0 
                    w-[200px] h-full left-[50%]
                    transition-opacity duration-200 ease-in-out flex justify-center items-center hover:opacity-75"
                >
                    <span className="icon-1 text-white text-3xl mx-2">🔍</span>
                    <span className="icon-2 text-white text-3xl mx-2">🛒</span>
                </div>
            </div>
