    ...
    useEffect(() => {
        ...
        const mapBookData = (books) => {
            return books.map((book) => {
                return {
                    field1: book.image, // Image URL
                    field2: book.name + " - " + book.author, // Book name + author
                    field3: book.category, // Category ("Danh mục")
                    field4: book.quantity, // Stock quantity
                    field5: book.price + "$", // Price
                    field6: book.description, // Description
                };
            });
        };
