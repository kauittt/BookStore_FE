...
import { selectTotalUsers, selectUser } from "../../redux/Reducer/userSlice";
...
const AdminPage = () => {
    ...
    console.log("BOOK");
    booksGrouped && console.log(booksGrouped);
    console.log("USER");
    totalUsers && console.log(totalUsers);
    console.log("CART");
    cart && console.log(cart);
    console.log("ORDERS");
    totalOrders && console.log(totalOrders);

    const totalBooks = booksGrouped?.reduce((total, category) => {
        return total + category.books.length;
    }, 0);
        ...
        >
            ...
            <div className="flex flex-col gap-[20px] pt-[20px] pr-[20px]">
                ...
                <div className="flex justify-between items-center ">
                    ...
                    <Card
                        name="Customer"
                        quantity={totalUsers?.length}
                        icon={faCircleUser}
                    ></Card>
                    <Card
                        name="Order"
                        quantity={totalOrders?.length}
