    ...
    return (
        <form className="max-w-xs mx-auto">
            <div className="relative flex items-center max-w-[8rem]">
                <FontAwesomeIcon
                    icon={faMinus}
                    className="text-base p-[10px] cursor-pointer text-gray-900 dark:text-white"
                    onClick={decrement}
                />
                <input
                    type="text"
                    ...
                    value={quantity}
                    readOnly
                    className="font-semibold w-[50px] text-center"
                ...
                <FontAwesomeIcon
                    icon={faPlus}
                    className="text-base p-[10px] cursor-pointer
