        ...
        <Routes location={location} key={location.pathname}>
            ...
            <Route path="/home" element={<PrivateRoute component={MainPage} />}>
                ...
                <Route
                    exact
                    path="/home/drink"
                    element={<PrivateRoute component={ManageMenu} />}
                />
                <Route
                    exact
                    path="/home/voucher"
                    element={<PrivateRoute component={Discount} />}
                />
                <Route
                    exact
                    path="/home/profile"
                ...
                <Route
                    exact
                    path="/home/static"
                    element={<PrivateRoute component={Statistic} />}
                />
                <Route
                    exact
                    path="/home/type"
                    element={<PrivateRoute component={ManageDrinkType} />}
                />
